...
const Home = () =>
    import ('@/routes/home/Home.vue')
const Find = () =>
    import ('@/routes/find/Find.vue')
const Cart = () =>
    import ("@/routes/cart/Cart.vue")
const User = () =>
    import ("@/routes/user/User.vue")
const GoodDetail = () =>
    import ('@/routes/home/GoodDetail.vue')
const Login = () =>
    import ("@/routes/user/Login.vue")
const Regist = () =>
    import ("@/routes/user/Regist.vue")
